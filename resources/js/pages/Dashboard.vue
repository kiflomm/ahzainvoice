            ...
            <div class="rounded-lg bg-white p-6 shadow-sm dark:bg-[#1a202c]">
                ...
                <div class="mt-4 space-y-3">
                    <div class="flex justify-between">
                        ...
                        <span class="text-sm font-medium text-[#28536B] dark:text-white">{{ summary.paidRecords }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-sm text-[#28536B]/70 dark:text-gray-400">Pending Records</span>
                        <span class="text-sm font-medium text-[#28536B] dark:text-white">{{ summary.pendingRecords }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-sm text-[#28536B]/70 dark:text-gray-400">Overdue Records</span>
                        <span class="text-sm font-medium text-[#28536B] dark:text-white">{{ summary.overdueRecords }}</span>
                    </div>
